...
/***/ function(module, exports, __webpack_require__) {
	...
	var frappegantt = __webpack_require__(5); /* global Snap, moment */
	
	function index(container, tasks, config) {
		...
		function prepareTasks() {
			...
			tasks.map(function (task) {
				if (task) {
					...
					if (task.parent_id) {
						var parent_id = task.parent_id.toString();
						if (ids.indexOf(parent_id) > -1) {
							task.dependencies = parent_id;
						}
					}
					var start = task.start_time || task.created_at;
		...
		function prepareContainer() {
			var html = '<div style="float: left"><svg id="legend" width="200" height="200"></svg></div>';
			html = html + '<div style="overflow: scroll"><svg id="gantt" width="200" height="200"></svg></div>';
			document.getElementById(container).innerHTML = html;
		}
	
		function render_gantt() {
			var view_mode = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Day';
		...
		function render_legend() {
			...
			tasks.map(function (task, index) {
				...
				if (task.developer) {
					...
					self.canvas.text(pos0, yy, fittingString(task.developer, 1, all_width)).addClass('developer').appendTo(self.developer);
				} else {
					var _priority = priority.hasOwnProperty(task.priority) ? priority[task.priority] : 'normal';
					var btn = self.canvas.circle(pos0 + cols[0] / 2 - 5, yy - 5, 11).addClass(_priority).appendTo(self.url);
					var url = 'http://troppus.itech-group.ru/tickets/'.concat(task.id);
					btn.node.addEventListener('click', function (evt) {
						window.open(url, '_blank');
					}, false);
				}
				if (task.project) {
					self.canvas.text(pos1, yy, fittingString(task.project, 0, cols[1])).addClass('label').appendTo(self.projects);
				}
				if (task.manager) {
					self.canvas.text(pos2, yy, fittingString(task.manager, 0, cols[2])).addClass('label').appendTo(self.managers);
				}
				if (task.status) {
					self.canvas.text(pos3, yy, fittingString(task.status, 0, cols[3])).addClass('label').appendTo(self.status);
				}
				if (task.time) {
					var time = moment({ hours: 0, minutes: 0 }).add(task.time, 'minutes').format('HH:mm');
					if (task.time > 1440) {
			...
			self.canvas.text(-5 + pos0 + cols[0] / 2, 50, fittingString('URL', 1, cols[0])).addClass('header').appendTo(self.projects);
			self.canvas.text(-5 + pos1 + cols[1] / 2, 50, fittingString('Проект', 1, cols[1])).addClass('header').appendTo(self.projects);
		...
		function fittingString(str) {
			var header = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
			var maxWidth = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 100;
		...
		function render_menu() {
			...
			view_modes.map(function (menu, index) {
				self.canvas.text(pos + 55 + index * 100, 21, menu).addClass('menu').appendTo(self.btns);
				var btn = self.canvas.rect(pos + 7 + index * 100, 7, 96, 20).addClass(index ? 'timebtn' : 'timebtn activebtn').appendTo(self.btns);
				btn.node.addEventListener('click', function (evt) {
					self.canvas.selectAll('.activebtn').forEach(function (el) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".header {\n  text-anchor: middle;\n  font-size: 14px;\n  font-weight: bold;\n  overflow: hidden;\n  font-family: sans-serif; }\n\n.developer {\n  font-size: 14px;\n  font-weight: bold;\n  font-family: sans-serif;\n  fill: #ffffff; }\n\n.label {\n  font-size: 12px;\n  font-weight: normal;\n  overflow: hidden;\n  font-family: sans-serif; }\n\n.menu {\n  text-anchor: middle;\n  font-size: 12px;\n  font-weight: bold;\n  font-family: sans-serif; }\n\n.grid {\n  stroke: #e0e0e0;\n  stroke-width: 0.4;\n  fill: transparent; }\n\n.bg {\n  fill: #ffffff; }\n\n.bg_row {\n  fill: #f5f5f5; }\n\n.bg_header {\n  fill: #a3a3ff; }\n\n.timebtn {\n  stroke: #e0e0e0;\n  stroke-width: 0.4;\n  fill: transparent;\n  cursor: pointer; }\n\n.activebtn {\n  fill: #ffffff;\n  opacity: 0.5;\n  cursor: auto; }\n\n.error {\n  fill: #ff0000;\n  opacity: 0.5;\n  cursor: pointer; }\n\n.low {\n  fill: #ffffcc;\n  stroke: #000000;\n  stroke-width: 0.5;\n  cursor: pointer; }\n\n.normal {\n  fill: #5cb85c;\n  stroke: #000000;\n  stroke-width: 0.5;\n  cursor: pointer; }\n\n.high {\n  fill: #d9534f;\n  stroke: #000000;\n  stroke-width: 0.5;\n  cursor: pointer; }\n", "", {"version":3,"sources":["/Users/cm/Projects/gantt/src/src/styles.scss"],"names":[],"mappings":"AAAA;EACC,oBAAmB;EACnB,gBAAe;EACf,kBAAiB;EACjB,iBAAgB;EAChB,wBAAuB,EACvB;;AACD;EACC,gBAAe;EACf,kBAAiB;EACjB,wBAAuB;EACvB,cAAa,EACb;;AACD;EACC,gBAAe;EACf,oBAAmB;EACnB,iBAAgB;EAChB,wBAAuB,EACvB;;AACD;EACC,oBAAmB;EACnB,gBAAe;EACf,kBAAiB;EACjB,wBAAuB,EACvB;;AACD;EACC,gBAAe;EACf,kBAAiB;EACjB,kBAAiB,EACjB;;AACD;EACC,cAAa,EACb;;AACD;EACC,cAAa,EACb;;AACD;EACC,cAAa,EACb;;AACD;EACC,gBAAe;EACf,kBAAiB;EACjB,kBAAiB;EACjB,gBAAe,EACf;;AACD;EACC,cAAa;EACb,aAAY;EACZ,aAAY,EACZ;;AACD;EACC,cAAa;EACb,aAAY;EACZ,gBAAe,EACf;;AACD;EACC,cAAa;EACb,gBAAe;EACf,kBAAiB;EACjB,gBAAe,EACf;;AACD;EACC,cAAa;EACb,gBAAe;EACf,kBAAiB;EACjB,gBAAe,EACf;;AACD;EACC,cAAa;EACb,gBAAe;EACf,kBAAiB;EACjB,gBAAe,EACf","file":"styles.scss","sourcesContent":[".header {\n\ttext-anchor: middle;\n\tfont-size: 14px;\n\tfont-weight: bold;\n\toverflow: hidden;\n\tfont-family: sans-serif;\n}\n.developer {\n\tfont-size: 14px;\n\tfont-weight: bold;\n\tfont-family: sans-serif;\n\tfill: #ffffff;\n}\n.label {\n\tfont-size: 12px;\n\tfont-weight: normal;\n\toverflow: hidden;\n\tfont-family: sans-serif;\n}\n.menu {\n\ttext-anchor: middle;\n\tfont-size: 12px;\n\tfont-weight: bold;\n\tfont-family: sans-serif;\n}\n.grid {\n\tstroke: #e0e0e0;\n\tstroke-width: 0.4;\n\tfill: transparent;\n}\n.bg {\n\tfill: #ffffff;\n}\n.bg_row {\n\tfill: #f5f5f5;\n}\n.bg_header {\n\tfill: #a3a3ff;\n}\n.timebtn {\n\tstroke: #e0e0e0;\n\tstroke-width: 0.4;\n\tfill: transparent;\n\tcursor: pointer;\n}\n.activebtn {\n\tfill: #ffffff;\n\topacity: 0.5;\n\tcursor: auto;\n}\n.error {\n\tfill: #ff0000;\n\topacity: 0.5;\n\tcursor: pointer;\n}\n.low {\n\tfill: #ffffcc;\n\tstroke: #000000;\n\tstroke-width: 0.5;\n\tcursor: pointer;\n}\n.normal {\n\tfill: #5cb85c;\n\tstroke: #000000;\n\tstroke-width: 0.5;\n\tcursor: pointer;\n}\n.high {\n\tfill: #d9534f;\n\tstroke: #000000;\n\tstroke-width: 0.5;\n\tcursor: pointer;\n}"],"sourceRoot":""}]);
